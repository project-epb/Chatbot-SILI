...
declare module 'koishi' {
  interface Context {
    homo: (input: any) => string
  }
}

export class PluginHomo extends BasePlugin {
 ...
 * @author itorr
 * @license MIT
 * @url https://github.com/itorr/homo/blob/b681fdaee48801bafc19b87fc2ec4444b44d52f9/homo.js
 */
const homo = ((Nums) => {
  ...
  return (num: any): string => finisher(demolish(num))
})({
