...
export const INFOBOX_MAP: {
  ...
  // 萌娘百科
  {
    ...
    injectStyles: [
      `body #moe-full-container > header#moe-global-header, body #moe-full-container > #moe-global-toolbar { display: none !important }`,
      `#bottomRightCorner {display:none!important}`,
    ]
  },
  // Minecraft Wiki
  {
